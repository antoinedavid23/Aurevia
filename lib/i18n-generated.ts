...
export const generatedMessages: Record<string, GeneratedLocalized> = {
  ...
  "Combien de temps faut-il pour démarrer ?": {
    ...
    "en": "How long does it take to start?",
    "es": "¿Cuánto tiempo tarda en empezar?",
    "ru": "Сколько времени нужно, чтобы начать?",
    "zh": "需要多长时间才能开始？"
  },
  ...
  "Consignes centralisées": {
    ...
    "en": "Centralized instructions",
    "es": "Instrucciones centralizadas",
  ...
  "Contraintes identifiées": {
    ...
    "en": "Constraints identified",
    "es": "Restricciones identificadas",
  ...
  "Création ou optimisation de l’annonce": {
    ...
    "en": "Creation or optimization of the ad",
  ...
  "Justificatifs classés": {
    ...
    "en": "Classified supporting documents",
    "es": "Documentos justificativos clasificados",
  ...
  "Prise en charge des imprévus": {
    ...
    "en": "Support for unforeseen events",
    "es": "Soporte ante imprevistos",
