...
export const services:Service[]=[
 {slug:"gestione-proprieta",title:"Gestione proprietà",short:"Un unico referente per coordinare ogni fase operativa.",number:"01"},
 {slug:"concierge",title:"Concierge",short:"Richieste selezionate e assistenza su misura.",number:"02"},
 {slug:"accoglienza-ospiti",title:"Accoglienza ospiti",short:"Un arrivo impeccabile, personale e discreto.",number:"03"},
 {slug:"pulizie-biancheria",title:"Pulizie e biancheria",short:"Standard elevati e controllo dopo ogni soggiorno.",number:"04"},
 {slug:"manutenzione",title:"Manutenzione",short:"Prevenzione, interventi e una rete locale affidabile.",number:"05"},
 {slug:"revenue-management",title:"Revenue management",short:"Strategia tariffaria indicativa e presentazione curata.",number:"06"},
 {slug:"sicurezza",title:"Sicurezza",short:"Controlli, inventari e procedure chiare.",number:"07"},
 {slug:"amministrazione",title:"Amministrazione",short:"Report trasparenti e documentazione ordinata.",number:"08"}].map((service,i)=>({...service,image:["/images/services/property-management.webp","/images/services/concierge-service.webp","/images/services/guest-welcome.webp","/images/services/housekeeping.webp","/images/services/maintenance.webp","/images/services/revenue-management.webp","/images/services/security.webp","/images/services/administration.webp"][i]}));
export const properties:Property[]=[
 ...
 {slug:"attico-aurelia",name:"Attico Aurelia",location:"Genova",bedrooms:3,guests:6,baths:2,tone:2,image:"/images/home/luxury-bedroom.webp"},
...
export const experiences=[
 ...
 ["esperienze-locali","Esperienze locali","Luoghi, botteghe e incontri selezionati."],
...
export const faqs=[
 ...
 ["Il simulatore garantisce i ricavi indicati?","No. Restituisce una stima puramente indicativa basata su coefficienti interni e richiede una valutazione personalizzata."],
