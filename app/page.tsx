...
export default function Home(){
 return <>
  ...
  <section className="section home-services"><div className="container"><Reveal><p className="eyebrow">Services</p><h2>L’excellence dans chaque détail</h2></Reveal><div className="card-grid three">{services.slice(0,6).map(s=><ServiceCard key={s.slug} service={s}/>)}</div><Link className="text-link mobile-services-link" href="/servizi">Voir tous les services <ArrowRight size={15}/></Link></div></section>
