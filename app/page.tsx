...
export default function Home(){
 return <>
  ...
  <section className="section signature-section ivory"><div className="container signature-layout">
   <Reveal className="signature-visual visual-bedroom"><div><span>La présence AUREVIA</span><strong>Votre propriété, toujours prête. Toujours préservée.</strong></div></Reveal>
   <Reveal className="signature-content"><p className="eyebrow dark">L’expérience propriétaire</p><h2>Tout est pris en charge.<br/>Rien n’est laissé au hasard.</h2><p className="signature-lead">Une propriété d’exception mérite davantage qu’une gestion efficace. Elle exige une présence capable d’anticiper, de décider et d’agir en votre nom, avec la même attention que vous.</p>
    <div className="signature-pillars">
     <article><span>01</span><div><h3>Un interlocuteur qui connaît votre bien</h3><p>Vos préférences, vos exigences et chaque particularité du lieu sont connues, suivies et respectées.</p></div></article>
     <article><span>02</span><div><h3>Une vigilance qui précède les imprévus</h3><p>Nous contrôlons, coordonnons et intervenons avant que le moindre détail ne devienne une contrainte.</p></div></article>
     <article><span>03</span><div><h3>Une valeur préservée dans le temps</h3><p>Chaque décision protège le caractère de la propriété tout en soutenant durablement sa performance.</p></div></article>
    </div>
    <Link className="text-link signature-link" href="/proprietari">Découvrir l’accompagnement propriétaire <ArrowRight size={15}/></Link>
   </Reveal>
  </div></section>
  ...
  <section className="section final-cta"><ShieldCheck/><h2>Votre propriété mérite une gestion à sa hauteur</h2><p>Confiez-nous vos exigences. Nous imaginerons un accompagnement confidentiel, façonné autour de votre propriété.</p><Link className="button" href="/valutazione">Solliciter une étude confidentielle</Link></section>
 </>;
}
