...
export default function Home(){
 return <>
  ...
  <section className="section home-gallery ivory"><div className="container"><Reveal className="identity-heading"><div><p className="eyebrow dark">La signature AUREVIA</p><h2>Le privilège d’une présence qui anticipe tout</h2></div><p>AUREVIA ne se contente pas de gérer une propriété. Nous en préservons le caractère, orchestrons chaque séjour et veillons sur chaque détail avec une exigence constante — pour que vous puissiez en profiter sans jamais en porter les contraintes.</p></Reveal><div className="editorial-grid identity-grid"><div className="visual visual-bedroom"><span><b>01</b> Un accueil parfaitement orchestré</span></div><div className="visual visual-coast"><span><b>02</b> Une maîtrise intime de la Ligurie</span></div><div className="visual visual-night"><span><b>03</b> Une vigilance silencieuse, à chaque instant</span></div><div className="visual visual-key"><span><b>04</b> Une exigence qui se reconnaît</span></div></div></div></section>
