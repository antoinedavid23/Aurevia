...
export default function Home(){
 return <>
  ...
  <section className="section simulator-teaser simulator-photo"><div className="container split">
   ...
   <Reveal className="estimate-card estimate-premium"><div className="estimate-brand"><span className="estimate-logo-crop" aria-hidden="true"><Image src="/images/brand/aurevia-logo-transparent-gold.png" width={160} height={160} alt=""/></span><span>Projection AUREVIA</span></div><p className="estimate-case">Cas illustratif · appartement 2 chambres à Gênes</p><div className="estimate-comparison"><div><small>Situation estimée avant gestion</small><b>29 800 €</b></div><i>→</i><div><small>Potentiel optimisé</small><strong>50 900 €</strong></div></div><div className="estimate-gain"><span>Progression indicative</span><b>+ 71 %</b></div><div><small>Tarif moyen projeté</small><b>265 € / nuit</b></div><div><small>Occupation projetée</small><b>64 % · 192 nuits</b></div><p>Projection illustrative avant frais, fiscalité et interventions. Une analyse personnalisée reste indispensable.</p></Reveal>
  </div></section>
