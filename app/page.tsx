...
export default function Home(){
 return <>
  ...
  <section className="section simulator-teaser simulator-photo"><div className="container split">
   ...
   <Reveal className="estimate-card"><span>Cas illustratif · appartement 2 chambres à Gênes</span><strong>50 900 € <small>brut / an</small></strong><div><small>Tarif moyen projeté</small><b>265 € / nuit</b></div><div><small>Occupation projetée</small><b>64 % · 192 nuits</b></div><div><small>Gestion AUREVIA · 25 % TTC</small><b>− 12 725 €</b></div><div className="estimate-net"><small>Revenu après gestion</small><b>38 175 €</b></div><p>Avant ménage, linge, consommables, fiscalité et interventions. Exemple indicatif, sans garantie de revenus.</p></Reveal>
  </div></section>
